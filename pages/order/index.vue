...
const orders = data.value?.filter(x => {
  ...
  <div>
    <UContainer>
      <div class="flex flex-wrap justify-center mt-12 lg:mt-20">
        ...
        <div class="flex flex-wrap justify-center" v-if="orders">
          <div
              class="w-full mt-12 p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700" v-for="order in orders">
